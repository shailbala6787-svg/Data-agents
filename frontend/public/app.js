  ...
  if (list && (!csvTables || csvTables.length === 0)) {
    list.innerHTML = `
      <div class="empty-state">
        <div style="border: 4px solid rgba(0, 0, 0, 0.1); border-left-color: var(--primary); border-radius: 50%; width: 32px; height: 32px; animation: spin 1s linear infinite; margin: 0 auto 10px;"></div>
